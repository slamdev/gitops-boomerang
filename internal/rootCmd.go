...
const rootCmdName = "gitops-boomerang"

var rootCmd = &cobra.Command{
	Use:   rootCmdName,
	Short: rootCmdName + " Gets a feedback from deployed application",
	Long: rootCmdName + ` Gets a feedback from deployed application
